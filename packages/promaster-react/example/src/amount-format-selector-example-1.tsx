...
const AmountFormatWrapper = (props: AmountFields.AmountFormatWrapperProps) => <AmountFields.AmountFormatWrapper className={props.active ? "active" : "inactive"} {...props} />
      ...
      <div>
        ...
        <div>
          ...
          <AmountFormatSelector selectedUnit={this.state.selectedUnit}
            ...
            onFormatChanged={(selectedUnit: Unit.Unit<any>, selectedDecimalCount: number) => this.setState(merge(this.state, { selectedUnit, selectedDecimalCount }))}
