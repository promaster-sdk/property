...
export declare type OnPropertyFormatCleared = (propertyName: string) => void;
...
export declare type ReactComponent<T> = React.ComponentClass<T> | React.StatelessComponent<T>;
