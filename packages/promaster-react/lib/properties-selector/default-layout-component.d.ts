...
export declare function DefaultLayoutComponent({selectors, translateGroupName, closedGroups, onToggleGroupClosed, GroupComponent, GroupItemComponent, PropertySelectorComponent, PropertyLabelComponent}: LayoutComponentProps): JSX.Element;
