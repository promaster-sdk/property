...
import {AmountInputBox, AmountFormatSelector, OnFormatChanged, AmountFormatSelectorClassNames, AmountInputBoxClassNames} from "amount-fields";
...
export class AmountPropertySelector extends React.Component<AmountPropertySelectorProps, any> {
	...
	render() {
		...
		let value = propertyValueSet.getAmount(propertyName, () => null);
