...
class PropertiesSelectorExample3AutoSelectAndLockSingleValidValue extends React.Component<{}, State> {
  constructor(props: {}) {
    super(props);
    this.state = {
...
function exampleProductProperties(): ReadonlyArray<PropertiesSelector.Property> {
  return [
    {
      sort_no: 1,
      name: "a",
...
export const Example3 = (): JSX.Element => <PropertiesSelectorExample3AutoSelectAndLockSingleValidValue />;
