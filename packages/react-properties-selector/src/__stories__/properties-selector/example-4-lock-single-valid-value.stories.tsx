...
class PropertiesSelectorExample4LockSingleValidValue extends React.Component<{}, State> {
  constructor(props: {}) {
    super(props);
    this.state = {
...
export const Example4 = (): JSX.Element => <PropertiesSelectorExample4LockSingleValidValue />;
