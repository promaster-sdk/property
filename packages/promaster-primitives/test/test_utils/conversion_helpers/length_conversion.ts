...
export class LengthConversion {
  ...
  static  Cm2Yd(cm: number): number {
    return LengthConversion.Ft2Yd(LengthConversion.M2Ft(LengthConversion.Cm2M(cm)));
  }
  ...
  static  Km2In(km: number): number {
    return LengthConversion.Ft2In(LengthConversion.M2Ft(LengthConversion.Km2M(km)));
  }
