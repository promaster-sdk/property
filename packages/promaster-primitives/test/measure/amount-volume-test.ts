...
describe("amount_volume_test", () => {
  ...
  it("For_Value_0_liter_we_should_get_value_0_cubic_meter", () => {
		...
		const amountToTest: Amount.Amount<Volume> = Amount.create(value, Units.Liter);
		const convertedAmount: number = Amount.valueAs(Units.CubicMeter, amountToTest);
  ...
  it("For_Value_0_cubic_meter_we_should_get_value_0_liter", () => {
    const value: number = 0.0;
		  const amountToTest: Amount.Amount<Volume> = Amount.create(value, Units.CubicMeter);
  ...
  it("For_Value_100_hcf_we_should_get_value_10000_ft3", () => {
		...
		const amountToTest: Amount.Amount<Volume> = Amount.create(value, Units.HundredCubicFeet);
		const convertedAmount: number = Amount.valueAs(Units.CubicFeet, amountToTest);
