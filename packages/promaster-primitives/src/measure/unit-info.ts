...
export const getUnitInfo = ((unit: Unit.Unit<any>) => <UnitInfo>Object.assign({}, units.get(unit)));
export const getSiUnitInfo = ((unit: Unit.Unit<any>) => <UnitInfo>Object.assign({}, siUnits.get(unit)));
export const getIpUnitInfo = ((unit: Unit.Unit<any>) => <UnitInfo>Object.assign({}, ipUnits.get(unit)));
...
function addUnit(unit: Unit.Unit<any>, measureSystem:string, decimalCount:number, coUnit?: Unit.Unit<any>) {
