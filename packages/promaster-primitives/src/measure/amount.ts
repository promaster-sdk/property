...
export function isQuantity<T extends Quantity>(quantityType: T, amount: Amount<T>): boolean {
...
function _getQuantityType<T extends Quantity>(unit: Unit.Unit<T>): Quantity {
