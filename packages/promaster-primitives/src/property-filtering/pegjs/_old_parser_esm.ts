...
function peg$parse(input, options) {
	...
	function stringToComparisonOperationType(str) {
		if (str == ">") return 0; //ComparisonOperationType.Greater;
		if (str == "<") return 1; //ComparisonOperationType.Less;
		if (str == ">=") return 2; //ComparisonOperationType.GreaterOrEqual;
		return 3; //ComparisonOperationType.LessOrEqual;
	}

	function stringToEqualsOperationType(str) {
		if (str == "=") return 0; //EqualsOperationType.Equals;
