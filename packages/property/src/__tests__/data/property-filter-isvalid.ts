...
export const tests = [
  ...
  {
    name: "should_accept_properties_when_filter_contains_several_matching_properties_with_single_value",
    pvs: "a=1;b=2;c=3;d=4;e=5;f=6;",
    f: "a=1&c=3&f=6",
    result: true,
  },
  {
    name: "should_accept_properties_when_filter_contains_one_matching_property_with_single_value",
    pvs: "a=1;b=2;c=3;d=4;e=5;f=6;",
    f: "a=1",
    result: true,
  },
  {
    name: "should_accept_properties_when_filter_contains_one_matching_property_with_single_range_value",
    pvs: "a=1;b=2;c=3;d=4;e=5;f=6;",
    f: "a=-1~10",
    result: true,
  },
  ...
  //olle
  {
    name: "should_accept_properties_when_filter_contains_one_matching_property_with_set_of_values",
    pvs: "a=1;b=2;c=3;d=4;e=5;f=6;",
    f: "b=1,2,5",
    result: true,
  },
  {
    name: "should_accept_properties_when_filter_contains_one_matching_property_with_mixed_values",
    pvs: "a=1;b=2;c=3;d=4;e=5;f=6;",
    f: "b=-1,1,2,5,10~15",
    result: true,
  },
  ...
  {
    name: "should not assert systemarrangement=1 as valid for systemarrangement!=1~2",
  ...
  // Custom compare
  {
    ...
    f: "a=b&c>d",
    result: true,
    comparer: (left: PropertyValue.PropertyValue, right: PropertyValue.PropertyValue) => {
      switch (left.type) {
        case "text":
