...
export function createLine(start: Point.Point, end: Point.Point,
                       strokeColor: Color.Color, strokeThickness: number): Line {
  return {
    type: "line",
    start: start,
    end: end,
...
export function createPolygon(points: Array<Point.Point>, strokeColor: Color.Color,
                       strokeThickness: number, fillColor: Color.Color): Polygon {
  return {
    type: "polygon",
    points: points,
    strokeColor: strokeColor,
...
export function createText(position: Point.Point, text: string, fontFamily: string, fontSize: number,
                       textColor: Color.Color, fontWeight: AbstractFontWeight, clockwiseRotationDegrees: number,
                       textAlignment: TextAlignment, horizontalGrowthDirection: GrowthDirection, verticalGrowthDirection: GrowthDirection,
                       strokeThickness: number, strokeColor: Color.Color): Text {
  return {
    type: "text",
    position: position,
    text: text,
...
export function createVectorImage(topLeft: Point.Point, image: Component): VectorImage {
  return {
    type: "vectorimage",
    topLeft: topLeft,
    image: image,
