            ...
            TableRow.create({
              height: 10, cells: [
                ...
                TableCell.create({
                  elements: [
                    Paragraph.create({
                      atoms: [TextRun.create({text: "Test", textProperties: TextProperties.create({fontFamily: "Helvetica", fontSize: 10,})})]
                    })
                  ]
                })
...
export function generateHyperlink(): AbstractDoc.AbstractDoc {
  ...
  return AbstractDoc.create({
    sections: [Section.create({
      page: page, sectionElements: [
        Paragraph.create({atoms: [HyperLink.create({text: "this is a link to google", target: "https://www.google.com"})]})
      ]
    })],
    styles: DefaultStyles.createDefaultAndStandardStyles(),
  });
