...
import { getDefaultAmountInputBoxStyle, useAmountInputBox } from "@promaster-sdk/react-property-selectors";

interface State {
  readonly value: Amount.Amount<unknown>;
}

export function AmountInputBoxExample1Hooks(): React.ReactElement<{}> {
